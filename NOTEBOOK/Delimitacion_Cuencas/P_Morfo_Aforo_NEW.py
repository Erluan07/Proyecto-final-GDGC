...
#expression = "Con(\"{}\" >= 10000, 1)".format(FlowAcc_tif)
...
for cuenca_id in range(total_cuencas):
    ...
    arcpy.SelectLayerByAttribute_management("cuencas_layer2", "NEW_SELECTION", "gridcode = {}".format(cuenca_id + 1))
    ...
    try:
        # Usar cuenca_temp en lugar de salida_cuenca en los procesos siguientes
